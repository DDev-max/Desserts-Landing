...
import { Question, Recipe } from 'schema-dts';
    ...
    const faqPage: FaqAPI[] = [
        {
            ...
            answer: "Yes, we do! You can place custom orders for cakes, cupcakes, and other desserts for special occasions like birthdays, weddings, or corporate events.",
        }
    ];
